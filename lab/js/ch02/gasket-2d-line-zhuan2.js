...
window.onload = function initTriangles(){
	var	lab2_e01=document.getElementById('lab2_e01');
	var	lab2_e02=document.getElementById('lab2_e02');
	...
	lab2_e01.onmouseup = function(){
		points = [];
		numTimesToSubdivide = lab2_e01.value;
		initTriangles();
	}
	
	lab2_e02.onmouseup = function(){
		points = [];
		theta = lab2_e02.value;
		initTriangles();
	}
